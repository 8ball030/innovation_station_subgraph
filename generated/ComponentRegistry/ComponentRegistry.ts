...
export class ComponentRegistry__getDependenciesResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class ComponentRegistry__getLocalSubComponentsResult {
  value0: Array<BigInt>;
  value1: BigInt;
...
export class ComponentRegistry__getUnitResultUnitStruct extends ethereum.Tuple {
  get unitHash(): Bytes {
...
export class ComponentRegistry__getUpdatedHashesResult {
  value0: BigInt;
  value1: Array<Bytes>;
...
export class ComponentRegistry extends ethereum.SmartContract {
  static bind(address: Address): ComponentRegistry {
    return new ComponentRegistry("ComponentRegistry", address);
  }
  ...
  getDependencies(unitId: BigInt): ComponentRegistry__getDependenciesResult {
    let result = super.call(
      "getDependencies",
    ...
    return new ComponentRegistry__getDependenciesResult(
      result[0].toBigInt(),
  ...
  try_getDependencies(
    unitId: BigInt
  ): ethereum.CallResult<ComponentRegistry__getDependenciesResult> {
    let result = super.tryCall(
      "getDependencies",
      "getDependencies(uint256):(uint256,uint32[])",
      [ethereum.Value.fromUnsignedBigInt(unitId)]
    ...
    return ethereum.CallResult.fromValue(
      new ComponentRegistry__getDependenciesResult(
        value[0].toBigInt(),
  ...
  getLocalSubComponents(
    unitId: BigInt
  ): ComponentRegistry__getLocalSubComponentsResult {
    let result = super.call(
      "getLocalSubComponents",
    ...
    return new ComponentRegistry__getLocalSubComponentsResult(
  ...
  try_getLocalSubComponents(
    unitId: BigInt
  ): ethereum.CallResult<ComponentRegistry__getLocalSubComponentsResult> {
    let result = super.tryCall(
      "getLocalSubComponents",
      "getLocalSubComponents(uint256):(uint32[],uint256)",
      [ethereum.Value.fromUnsignedBigInt(unitId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ComponentRegistry__getLocalSubComponentsResult(
  ...
  getUnit(unitId: BigInt): ComponentRegistry__getUnitResultUnitStruct {
    let result = super.call(
      "getUnit",
    ...
    return changetype<ComponentRegistry__getUnitResultUnitStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_getUnit(
    unitId: BigInt
  ): ethereum.CallResult<ComponentRegistry__getUnitResultUnitStruct> {
    let result = super.tryCall(
      "getUnit",
      "getUnit(uint256):((bytes32,uint32[]))",
      [ethereum.Value.fromUnsignedBigInt(unitId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<ComponentRegistry__getUnitResultUnitStruct>(value[0].toTuple())
    );
  }

  getUpdatedHashes(unitId: BigInt): ComponentRegistry__getUpdatedHashesResult {
    let result = super.call(
      "getUpdatedHashes",
    ...
    return new ComponentRegistry__getUpdatedHashesResult(
      result[0].toBigInt(),
  ...
  try_getUpdatedHashes(
    unitId: BigInt
  ): ethereum.CallResult<ComponentRegistry__getUpdatedHashesResult> {
    let result = super.tryCall(
      "getUpdatedHashes",
      "getUpdatedHashes(uint256):(uint256,bytes32[])",
      [ethereum.Value.fromUnsignedBigInt(unitId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ComponentRegistry__getUpdatedHashesResult(
        value[0].toBigInt(),
